    ...
    <div>
        {!! Form::open(['url' => ['admin/galeria', $imagen->id_imagen], 'method' => 'POST']) !!}
            ...
            <div class="form-group">
                ...
                {{Form::text('url_imagen', $imagen->url_imagen,['class' => 'form-control','placeholder'=> 'Url imagen'])}}
            </div>

            <div class="form-group">
                {{Form::label('descripcion_imagen', 'Descripción de la imagen:')}}
                {{Form::textarea('descripcion_imagen', $imagen->descripcion_imagen, ['class' => 'form-control','placeholder'=> 'Descripción de la imagen'])}}
            </div>
